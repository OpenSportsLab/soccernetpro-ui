...
from PyQt6.QtWidgets import (
    ...
    QStyleOptionSlider, QStyle, QSlider
)
...
class DescriptionMediaPreview(QWidget):
    """
    Player Panel for Description Mode.
    Uses Shared VideoSurface but enables Infinite Loop.
    """
    def __init__(self, parent=None):
        ...
        self.v_layout.addWidget(self.surface, 1) 
        
        # Expose player
        self.player = self.surface.player
        
        # Description mode specific: Enable Infinite Loop
        ...
        # [CHANGED] Moved style to QSS (ID: descTimeLabel)
        self.time_label.setObjectName("descTimeLabel")
    ...
    def load_video(self, path):
        """Delegates loading to shared surface."""
        self.surface.load_source(path)
        
        # Description mode auto-play logic
        if path:
            self.player.play()
