...
# [关键新增] 引入新的 Localization UI
# 请确保 ui2/panels.py 文件已存在
from ui2.panels import LocalizationUI

# =============================================================================
# 1. Left Panel (Classification Mode) - 保持原样
# =============================================================================
...
# =============================================================================
# 2. Center Panel (Classification Mode) - 保持原样
# =============================================================================
...
# =============================================================================
# 3. Right Panel (Classification Mode) - 保持原样
# =============================================================================
...
class WelcomeWidget(QWidget):
    def __init__(self, parent=None):
        ...
        title = QLabel("SoccerNet Pro Analysis Tool")
        title.setStyleSheet("font-size: 32px; font-weight: bold; color: #00AACC;")
        title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.addWidget(title)
        
        subtitle = QLabel("Select an option to start")
        ...
        self.import_btn = QPushButton("Import JSON Project")
...
# =============================================================================
# 5. Main Window UI (Refactored to StackedLayout)
# =============================================================================
class MainWindowUI(QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        # Stack to hold [WelcomeScreen, ClassificationInterface, LocalizationInterface]
        ...
        # --- Index 1: Classification Interface (Original UI) ---
        self.classification_container = QWidget()
        self.class_h_layout = QHBoxLayout(self.classification_container)
        self.class_h_layout.setContentsMargins(0, 0, 0, 0)
        self.class_h_layout.setSpacing(0)
        
        self.left_panel = LeftPanel()
        self.center_panel = CenterPanel()
        self.right_panel = RightPanel()
        
        self.class_h_layout.addWidget(self.left_panel)
        self.class_h_layout.addWidget(self.center_panel, 1)
        self.class_h_layout.addWidget(self.right_panel)
        
        self.stack_layout.addWidget(self.classification_container)
        
        # --- Index 2: Localization Interface (NEW UI) ---
    ...
    def show_classification_view(self):
        """Switches to the standard classification view (Left/Center/Right panels)."""
        self.stack_layout.setCurrentWidget(self.classification_container)
    
    def show_main_view(self):
        """Alias for show_classification_view (for compatibility)."""
        self.show_classification_view()

    def show_localization_view(self):
        """Switches to the new localization/spotting view."""
        self.stack_layout.setCurrentWidget(self.localization_ui)
